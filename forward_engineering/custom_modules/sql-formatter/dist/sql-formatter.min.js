	...
	return (function (e) {
				...
				a = (function () {
					...
					return (
						...
						(e.prototype.getFormattedQueryFromTokens = function () {
							...
							return (
								this.tokens.forEach(function (E, n) {
									(e.index = n),
										E.type === N.default.WHITESPACE ||
											(E.type === N.default.LINE_COMMENT
												? (t = e.formatLineComment(E, t))
												: E.type === N.default.BLOCK_COMMENT
													? (t = e.formatBlockComment(E, t))
													: E.type === N.default.RESERVED_TOPLEVEL
														? ((t = e.formatToplevelReservedWord(E, t)),
															(e.previousReservedWord = E))
														: E.type === N.default.RESERVED_NEWLINE
															? ((t = e.formatNewlineReservedWord(E, t)),
																(e.previousReservedWord = E))
															: E.type === N.default.RESERVED
																? ((t = e.formatWithSpaces(E, t)),
																	(e.previousReservedWord = E))
																: (t =
																		E.type === N.default.OPEN_PAREN
																			? e.formatOpeningParentheses(E, t)
																			: E.type === N.default.CLOSE_PAREN
																				? e.formatClosingParentheses(E, t)
																				: E.type === N.default.PLACEHOLDER
																					? e.formatPlaceholder(E, t)
																					: ',' === E.value
																						? e.formatComma(E, t)
																						: ':' === E.value
																							? e.formatWithSpaceAfter(
																									E,
																									t,
																								)
																							: '.' === E.value
																								? e.formatWithoutSpaces(
																										E,
																										t,
																									)
																								: ';' === E.value
																									? e.formatQuerySeparator(
																											E,
																											t,
																										)
																									: e.formatWithSpaces(
						...
						(e.prototype.formatOpeningParentheses = function (e, t) {
							...
							return (
								E.includes(this.previousToken().type) || (t = (0, T.default)(t)),
								(t += e.value),
								this.inlineBlock.beginIfPossible(this.tokens, this.index),
								this.inlineBlock.isActive() ||
									(this.indentation.increaseBlockLevel(), (t = this.addNewline(t))),
								t
							);
						}),
						(e.prototype.formatClosingParentheses = function (e, t) {
							return this.inlineBlock.isActive()
								? (this.inlineBlock.end(), this.formatWithSpaceAfter(e, t))
								: (this.indentation.decreaseBlockLevel(), this.formatWithSpaces(e, this.addNewline(t)));
						}),
						...
						(e.prototype.formatComma = function (e, t) {
							return (
								(t = this.trimTrailingWhitespace(t) + e.value + ' '),
								this.inlineBlock.isActive()
									? t
						...
						(e.prototype.trimTrailingWhitespace = function (e) {
							return this.previousNonWhitespaceToken().type === N.default.LINE_COMMENT
								? (0, T.default)(e) + '\n'
								: (0, T.default)(e);
						}),
					...
					return (
						...
						(e.prototype.tokenize = function (e) {
							for (var t = [], E = void 0; e.length; )
								(E = this.getNextToken(e, E)), (e = e.substring(E.value.length)), t.push(E);
							return t;
						}),
					...
					return (
						...
						(e.prototype.isForbiddenToken = function (e) {
							var t = e.type,
								E = e.value;
							return (
								t === T.default.RESERVED_TOPLEVEL ||
								t === T.default.RESERVED_NEWLINE ||
								t === T.default.COMMENT ||
								t === T.default.BLOCK_COMMENT ||
								';' === E
							);
						}),
						e
		...
		function (e, t, E) {
			...
			var r = E(2),
				...
				y = {};
			(y[l] = y[d] = y[P] = y[D] = y[U] = y[M] = y[h] = y[_] = y[v] = !0),
				(y[R] =
					y[N] =
					y[f] =
					y[i] =
