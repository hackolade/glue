...
const getScalarType = type => {
	...
	})('binary', () => 'blob')('boolean', simpleType)('blob', simpleType)('timestamp', simpleType)('date', simpleType)(
		'time',
		simpleType,
	)('duration', simpleType)('uuid', simpleType)('timeuuid', simpleType)(
...
const getHandlerByType = (type, udtTypeMap) =>
	getScalarType(type) || getStructuralTypeHandler(type, true, udtTypeMap) || getUDTHandler(type, udtTypeMap);
...
const getNestedTypeByData = (propertyData, isNeedToBeFrozen, udtTypeMap, propertyName) => {
	...
	const freezingType = (getStructuralTypeHandler(type, false, udtTypeMap) || getUDTHandler(type, udtTypeMap))(
		propertyData,
		propertyName,
	);
